...
class OpenAIClient extends LLMClient {
  ...
  async generate(prompt) {
    const body = { model: this.model, messages: [ { role: "system", content: "You are an expert tarot adviser. Respond ONLY with valid JSON matching the schema and input." }, { role: "user", content: prompt } ], temperature: this.temperature, response_format: { type: "json_object" } };
